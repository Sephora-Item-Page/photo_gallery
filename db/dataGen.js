...
const save = () => {
  ...
  let brush = {
    ...
    highRes: [
      "https://sephoraitems.s3-us-west-1.amazonaws.com/HighRes/Brushes/brush1.jpg",
    ],
  };
...
//     //   console.log('seeding error: ', err)
//     // })
//   .then(() => { mongoose.disconnect() }) //try to commment this out and see what happens
//   .catch(err => {
//     console.log('closing error: ', err)
//   });
