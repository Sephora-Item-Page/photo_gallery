...
const Arrow = styled.div`
  ...
  border: none;
  opacity: ${props => (props.slideNum !== props.slideMax ? `1` : `0.2`)};
`;
...
const ModalForwardArrow = (props) => {
  return (
    <Arrow disabled={props.slideNum === props.slideMax} slideMax={props.slideMax} slideNum={props.slideNum} onClick={props.moveForwardFunc}>
      <Svg>
...
export default ModalForwardArrow;